...
import { BsArrowRight, BsHeart, BsPeople, BsRocket } from 'react-icons/bs';
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-10">
              <div className="flex items-center gap-2 text-gray-300">
                <BsHeart size={18} className="text-red-400" />
                <span>Dedicated support</span>
              </div>
              <div className="flex items-center gap-2 text-gray-300">
                <BsRocket size={18} className="text-blue-400" />
                <span>Fast delivery</span>
              </div>
              <div className="flex items-center gap-2 text-gray-300">
                <BsPeople size={18} className="text-green-400" />
