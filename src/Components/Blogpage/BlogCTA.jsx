...
const BlogCTA = () => {
  ...
  const handleSubscribe = () => {
    if (email) {
      window.location.href = `mailto:hello@kodawave.com?subject=Newsletter Subscription&body=Please subscribe: ${email}`;
    }
  };
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
              ...
              <button 
                ...
                className="group px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-semibold flex items-center justify-center gap-2 hover:shadow-xl transition-all"
              >
                {t('subscribe')}
            ...
            <div className="flex items-center justify-center gap-4 mt-6 text-gray-400 text-sm">
              ...
              <span>{t('noSpam')}</span>
              <span>•</span>
              <span>{t('unsubscribeAnytime')}</span>
            </div>
          </div>
        </motion.div>
      </div>
